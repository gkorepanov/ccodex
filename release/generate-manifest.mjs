...
const manifest = { schemaVersion: 1, package: "@gkorepanov/ccodex", version: main.version, claudeAgentSdk: main.dependencies["@anthropic-ai/claude-agent-sdk"], artifacts };
